...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.factisresearch.html2pdf.js')
	...
	f = os.path.join(cwd,'Classes','ComFactisresearchHtml2pdfModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.factisresearch.html2pdf.js']
